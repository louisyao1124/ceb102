<template>
 ...
 <table width="200" border="1" cellpadding="0" cellspacing="0">
  <tr>
    <td><datetime format="YYYY-MM-DD H:i" width="300px" v-model="t6"></datetime></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;<input type="button" name="Submit" @click="showtime()" value="按鈕" /></td>
    <td>&nbsp;{{Date.now()}}</td>
    <td>&nbsp;{{prompt1("aa")}}</td>
  </tr>
  <tr>
