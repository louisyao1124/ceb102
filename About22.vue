...
// import FieldsDef from "./FieldsDef.js";    :fields="['name', 'nickname', 'email', 'gender']"
// data-path="https://vuetable.ratiw.net/api/users"
// pagination-path=""
...
externals: {
  ...
  mounted() {
    ...
    // VueCookies.set("name" , 12, "-1000h");
    alert(VueCookies.get("name"));
